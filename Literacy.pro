...
INCLUDEPATH += .
INCLUDEPATH += C:/tesseract/include  \
INCLUDEPATH += C:/tesseract/include/leptonica
INCLUDEPATH += C:/tesseract/include/tesseract
win32:CONFIG(release, debug|release): LIBS += -LC:/tesseract/lib/  \
tesseract50.lib
leptonica-1.74.4.lib
else:win32:CONFIG(debug, debug|release): LIBS += -LC:/opencv451/vc15/lib/  \
tesseract50d.lib
leptonica-1.74.4d.lib
DEPENDPATH += C:/tesseract/bin
...
#DEFINES += TESSDATA_PREFIX="D:/work/qtProject/opencvQT/Qt-5-and-OpenCV-4-Computer-Vision-Projects/Chapter-05/tesseract-master/tessdata/"
#DEFINES += TESSDATA_PREFIX=\\\"/home/kdr2/programs/tesseract-4.1.0/tessdata/\\\"
#DEFINES += TESSDATA_PREFIX \\\="C:/tesseract/tessdata"\\\
# Input
